...
@Autonomous(name = "Bogie Auton Depot Dump Short", group = "New")
//@Disabled

public class BogieAutonDepotDumpShort extends AbstractAutonNew {
    ...
    public void RegisterStates() {
        ...
        addState(new PathState("dump pause", "turn away from lander", () -> {
            RobotState.currentPath.pause();
            delay(Constants.DUMP_MINERAL_LONG_DELAY);
            RobotState.currentPath.resume();
            return true;
        }));
